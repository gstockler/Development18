...
for n = 1:N
    for t = 1:T
        for m = 1:M
            ...
            c_ns(m,t,n) = z_ns(n,1)*exp(-sigma_eps./2)*exp(log_eps(1,t));
...
h2.NumBins=15
axis tight
legend('Season+risk','No Season+risk','location','northwest')
legend boxoff
